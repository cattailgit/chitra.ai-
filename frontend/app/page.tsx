  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border border-gray-700 bg-gray-800/60 px-3 py-2.5">
      ...
      <div className="min-w-0">
        ...
        <p
          className={`truncate font-mono text-sm font-semibold ${valueClass}`}
        >
          {value}
        </p>
      </div>
...
function DetectionRow({
  ...
  return (
    <tr className="border-b border-gray-800 transition-colors hover:bg-gray-800/40">
      <td className="py-1.5 pl-3 pr-2 font-mono text-xs text-gray-500">
        {index + 1}
      </td>
      ...
      <td className="px-2 py-1.5 text-right font-mono text-xs text-yellow-300">
      ...
      <td
        className={`py-1.5 pr-3 text-right font-mono text-xs font-semibold ${adjConfColour(
    ...
    >
      ...
      {file ? (
        <>
          ...
          <p className="max-w-full truncate px-2 text-xs font-medium text-green-300">
            {file.name}
          </p>
                ...
                <table className="w-full min-w-full border-collapse text-left">
                  ...
                  <thead>
                    <tr className="border-b border-gray-700 bg-gray-800/60">
                      ...
                      <th className="px-2 py-2 text-[10px] uppercase tracking-wider text-gray-500">
                        Class
                      </th>

                      <th className="px-2 py-2 text-right text-[10px] uppercase tracking-wider text-gray-500">
                        Raw
                      </th>
                      ...
                      <th className="py-2 pr-3 text-right text-[10px] uppercase tracking-wider text-gray-500">
                        Adj. Conf
                      </th>
              ...
              result.agent_meta
                ...
                <div className="mt-1">
                  ...
                  <div className="flex flex-wrap gap-1">
                    ...
                    {result.agent_meta.retrieved_context_ids.map(
                      (id) => (
                        <span
                          key={id}
                          className="rounded border border-gray-700 bg-gray-800/60 px-1.5 py-0.5 font-mono text-[10px] text-gray-500"
                        >
                          {id}
                        </span>
                      )
